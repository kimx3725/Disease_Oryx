...
whole_df <- readr::read_rds(here::here("data/HMM", "final_v_hmm_prep_data.rds"))
...
Par0_4s <- list(step = list(mean = c(400, 50, 100, 50), 
                            sd = c(400, 50, 100, 50)),
                angle = list(mu = c(0, 0, 0, 0), 
                             kappa = c(0.05, 0.1, 0.01, 0.1))
                )
...
# save the hmm output 
#saveRDS(df, "whole_hmmTMB_sequence.rds")
