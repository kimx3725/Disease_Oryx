...
oryx <- readr::read_rds(here::here("data/HMM", "40inds_final_hmm_prep_data.rds"))
...
# save the hmm output 
saveRDS(hmm, "pool_hmm_shrub_trial6.rds")
...
pdf("pool_HMM_Oryx_shrub_m6.pdf")
...
saveRDS(data_hmm, "pool_hmm_shrub_sequence_trial6.rds")
```
