...
actual_m_hmm <- readr::read_rds(here::here("data/HMM_outputs", "hmm_m3_output.rds"))
actual_m_hmm
```
...
# add true values 
hmm_estimate_tpm$true <- c(-0.73438984, -0.05633548, -1.80512079, -0.08053237, -7.1703737, 0.1882292, -9.4655442, 0.0793542, -2.63575764, 0.06952902, -0.80415992, 0.03490285, -5.63262700, 0.08677426)
...
saveRDS(metrics, "HMM_sim_accu_metrics.rds")
```
