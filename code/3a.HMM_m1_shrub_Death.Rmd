...
```{r read in prep data}
# Location data of the oryx: 68 individuals 
oryx <- readr::read_rds(here::here("data/HMM", "HMM_prep_data_Death.Rdata"))
...
saveRDS(data_hmm, "HMM_m1_sequence.rds")
```
