...
Par0_4s <- list(step = c(16000, 7500, 10000, 650,
                         16000, 7500, 10000, 650), 
                angle = c(0.5, 0.1, 0.25, 0.1)
                )
...
# set up the state statue from the initial data
data_hmm1$state <- whole_df$state
```
