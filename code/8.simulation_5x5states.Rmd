...
ggplot(plot_sl, aes(x = x, y = value, color = factor(name)))+
  ...
  scale_color_manual(name = "Distribution",
                     #breaks = c("ni_r", "ni_e", "i_e", "i_e", "d"),
                     values = c("blue", "orange", "red", "darkgreen", "purple"))+
  theme_bw()
```
...
#saveRDS(state_info, "sim_state_info_id1_60days.rds")
```
...
# save the data
#saveRDS(ssf_df, "ssf_sim_trk_60days.rds")
```
