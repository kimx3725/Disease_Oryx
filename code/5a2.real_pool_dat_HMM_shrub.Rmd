...
data_hmm <- momentuHMM::prepData(whole_df, type = "UTM", covNames = "shrub")
...
# save the hmm output 
saveRDS(hmm, "pool_hmm_shrub.rds")
...
saveRDS(data_hmm, "pool_hmm_shrub_sequence.rds")
```
