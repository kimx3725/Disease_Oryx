...
betas <- list(
  beta_12 = c(-2, 1.2),   # From state 1 to state 2
  beta_21 = c(-4, -0.5),  # From state 2 to state 1
  beta_24 = c(-6, 1.5),   # From state 2 to state 4
  beta_25 = c(-5, 1.1),   # From state 2 to state 5
  beta_34 = c(-8, 1.9),   # From state 3 to state 4
  beta_43 = c(-10, 0.9),  # From state 4 to state 3
  beta_45 = c(-7, 1.2)    # From state 4 to state 5
)
```
...
# save the data
#saveRDS(ssf_df, here::here("data/simulation_data", "sim3_trk_10ids_1.rds"))
```
