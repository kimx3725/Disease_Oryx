...
m1 <- readr::read_rds(here::here("data/HMM_outputs", "hmm_m1_output.rds"))
...
meanNE <- m1$mle$step[1,1]
sdNE <- m1$mle$step[2,1] 

meanNR <- m1$mle$step[1,2]
sdNR <- m1$mle$step[2,2]  

meanIE <- m1$mle$step[1,3]
sdIE <- m1$mle$step[2,3]  

meanIR <- m1$mle$step[1,4] 
sdIR <- m1$mle$step[2,4]

meanD <- m1$mle$step[1,5]
sdD <- m1$mle$step[2,5]
