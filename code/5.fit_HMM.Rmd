...
whole_df <- whole_df %>% mutate(per_shrub = (shrub/sum(shrub))*100)
...
# Initial parameters
# (step mean for state 1, step mean for state 2, step SD s1, step SD s2) and (angle concentration s1, angle concentration s2)
Par0_2s <- list(step = c(1000, 250, 1000, 250), 
                angle = c(3, 0.1),
                per_shrub = c(0.1, 0.86, 3, 0.9),
                BC = c(0.1, 0.9))
